...
if __name__ == '__main__':
    ...
    optimizer = optim.SGD(model.parameters(), lr=0.01,momentum=0.9,dampening=0.1,weight_decay=0.05)
    manual_vec_1 = 0
    manual_vec_2 = 0
    # sys.exit()
    ...
    for epoch in range(5):
        ...
        gard_1 = gard_1 + model.conv_1.weight.data * 0.05
        gard_2 = gard_2 + model.conv_2.weight.data * 0.05
        if epoch==0:
            manual_vec_1 = 0.9 * manual_vec_1 + gard_1
            manual_vec_2 = 0.9 * manual_vec_2 + gard_2
        else:
            manual_vec_1 = 0.9 * manual_vec_1 + gard_1 * (1 - 0.1)
            manual_vec_2 = 0.9 * manual_vec_2 + gard_2 * (1 - 0.1)
        manual_data_1 = model.conv_1.weight.data  - 0.01 * manual_vec_1
        manual_data_2 = model.conv_2.weight.data  - 0.01 * manual_vec_2
