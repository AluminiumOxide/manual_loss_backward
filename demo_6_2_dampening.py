...
if __name__ == '__main__':
    ...
    optimizer = optim.SGD(model.parameters(), lr=0.01,momentum=0.9,dampening=0.1)
    manual_vec_1 = 0
    manual_vec_2 = 0
    # sys.exit()
    ...
    for epoch in range(5):
        ...
        loss.backward()
        if epoch==0:
            manual_vec_1 = 0.9 * manual_vec_1 + model.conv_1.weight.grad
            manual_vec_2 = 0.9 * manual_vec_2 + model.conv_2.weight.grad
        else:
            manual_vec_1 = 0.9 * manual_vec_1 + model.conv_1.weight.grad * (1-0.1)
            manual_vec_2 = 0.9 * manual_vec_2 + model.conv_2.weight.grad * (1-0.1)
